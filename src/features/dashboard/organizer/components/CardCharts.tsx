...
import useGetTransactionsData from "@/hooks/api/dashboard-organizer/useGetTransactionsData";
...
const generateMonthlyData = (data: any[], year: number) => {
  ...
  return months.map((month) => {
    ...
    return {
      ...
      ticketsSold: monthData ? monthData.ticketsSold : 0,
    };
  });
};
          ...
          <CardHeader className="flex items-center gap-2 space-y-0 border-b py-5 sm:flex-row">
            ...
            <div className="flex flex-col items-center gap-2 md:flex-row">
              ...
              <Select
                value={selectedData}
                onValueChange={(value) =>
                  setSelectedData(value as keyof typeof chartConfig)
                }
              >
                <SelectTrigger
                  className="w-[160px] rounded-lg sm:ml-auto"
                ...
                <SelectContent className="rounded-xl">
                  ...
                  <SelectItem value="ticketsSold" className="rounded-lg">
                    Tickets Sold
                  </SelectItem>
                </SelectContent>
              </Select>
